...
DELETE_REPORTED_MESSAGE = Templates("delete_reported_message.md")
DELETE_REPORTED_MESSAGE_BUTTON = Templates("delete_reported_message_button.md")
REPORTED_MESSAGE_DELETED = Templates('reported_message_deleted.md')
